...
const fr = {
  ...
  reset: {
    ...
    subtitle:       "Choisissez un nouveau mot de passe pour votre compte PluralRoaster.",
    ...
    errInvalidLink: "Ce lien de réinitialisation est invalide ou expiré.",
    errUnableToUpdate: "Impossible de mettre à jour le mot de passe.",
    msgUpdated:     "Mot de passe mis à jour. Vous pouvez retourner à l'application et vous connecter.",
